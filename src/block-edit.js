...
function EditComponent({ attributes, setAttributes }) {
  ...
  useEffect(() => {
    ...
    setAttributes({ qfInstanceId: id });
    // One-time instance id per block insertion.
  ...
  return (
    <>
      <InspectorControls>
        ...
        <PanelBody title="Single Template" initialOpen={false}>
          <p
            style={{
              fontSize: '11px',
              color: '#757575',
          ...
          >
            When enabled, single posts opened from this grid use the selected
            layout. Save the page and visit with ?qfr= on card links.
          </p>
          <ToggleControl
            label="Enable single template"
            checked={!!attributes.singleTemplateEnabled}
            onChange={(val) =>
              setAttributes({ singleTemplateEnabled: !!val })
            }
          />
          {attributes.singleTemplateEnabled && (
            <>
              <SelectControl
                label="Style"
                value={attributes.singleTemplateStyle || 'vertical'}
                options={[
                  { label: 'Vertical', value: 'vertical' },
                  { label: 'Horizontal', value: 'horizontal' },
                  { label: 'Minimal List', value: 'minimal-list' },
                  { label: 'Grid Card', value: 'grid-card' },
                  { label: 'Magazine', value: 'magazine' },
                ]}
                onChange={(val) =>
                  setAttributes({ singleTemplateStyle: val })
                }
              />
              <p
                style={{
              ...
              <ToggleControl
                label="Title"
                checked={!!attributes.singleShowTitle}
                onChange={(val) =>
                  setAttributes({ singleShowTitle: !!val })
                }
              />
              <ToggleControl
                label="Featured image"
                checked={!!attributes.singleShowImage}
                onChange={(val) =>
                  setAttributes({ singleShowImage: !!val })
                }
              />
              {attributes.singleShowImage && (
                <>
                  <SelectControl
                    label="Image position"
                    value={attributes.singleImagePosition || 'above-title'}
                    options={[
                    ...
                    onChange={(val) =>
                      setAttributes({ singleImagePosition: val })
                    }
                  />
                  <SelectControl
                    label="Image size"
                    value={attributes.singleImageSize || 'full'}
                    options={[
                      { label: 'Thumbnail', value: 'thumbnail' },
                      { label: 'Medium', value: 'medium' },
                      { label: 'Large', value: 'large' },
                    ...
                    onChange={(val) =>
                      setAttributes({ singleImageSize: val })
                    }
                  />
                </>
              )}
              <ToggleControl
                label="Content"
                checked={!!attributes.singleShowContent}
                onChange={(val) =>
                  setAttributes({ singleShowContent: !!val })
                }
              />
              <ToggleControl
                label="Excerpt"
                checked={!!attributes.singleShowExcerpt}
                onChange={(val) =>
                  setAttributes({ singleShowExcerpt: !!val })
                }
              />
              <ToggleControl
                label="Date"
                checked={!!attributes.singleShowDate}
                onChange={(val) =>
                  setAttributes({ singleShowDate: !!val })
                }
              />
              <ToggleControl
                label="Author"
                checked={!!attributes.singleShowAuthor}
                onChange={(val) =>
                  setAttributes({ singleShowAuthor: !!val })
                }
              />
              {attributes.singleShowAuthor && (
                <ToggleControl
                  label="Author avatar"
                  checked={!!attributes.singleShowAuthorAvatar}
                  onChange={(val) =>
                    setAttributes({ singleShowAuthorAvatar: !!val })
                  }
                />
              )}
              <ToggleControl
                label="Categories & tags"
                checked={!!attributes.singleShowTerms}
                onChange={(val) =>
                  setAttributes({ singleShowTerms: !!val })
                }
              />
              <ToggleControl
                label="Previous / next navigation"
                checked={!!attributes.singleShowNavigation}
                onChange={(val) =>
                  setAttributes({ singleShowNavigation: !!val })
                }
              />
              <p
                style={{
              ...
              >
                Typography & colors (0 = inherit)
              </p>
              <RangeControl
                label="Title font size (px)"
                value={attributes.singleTitleFontSize || 0}
                onChange={(val) =>
                  setAttributes({ singleTitleFontSize: val ?? 0 })
                }
                min={0}
                max={96}
              />
              <QFColorControl
                label="Title color"
                value={attributes.singleTitleColor || ''}
                onChange={(val) => setAttributes({ singleTitleColor: val })}
              />
              <SelectControl
                label="Title alignment"
                value={attributes.singleTitleAlignment || 'left'}
                options={[
                  { label: 'Left', value: 'left' },
                  { label: 'Center', value: 'center' },
                  { label: 'Right', value: 'right' },
                ...
                onChange={(val) =>
                  setAttributes({ singleTitleAlignment: val })
                }
              />
              <RangeControl
                label="Content font size (px)"
                value={attributes.singleContentFontSize || 0}
                onChange={(val) =>
                  setAttributes({ singleContentFontSize: val ?? 0 })
                }
                min={0}
                max={96}
              />
              <TextControl
                ...
                help="Unitless (e.g. 1.6) or size with unit"
                value={
                  attributes.singleContentLineHeight === 0
                    ? ''
                    : String(attributes.singleContentLineHeight)
                }
                onChange={(val) => {
                  const n = parseFloat(val);
                  setAttributes({
                    singleContentLineHeight:
              ...
              <QFColorControl
                label="Content color"
                value={attributes.singleContentColor || ''}
                onChange={(val) =>
                  setAttributes({ singleContentColor: val })
                }
              />
              <RangeControl
                label="Excerpt font size (px)"
                value={attributes.singleExcerptFontSize || 0}
                onChange={(val) =>
                  setAttributes({ singleExcerptFontSize: val ?? 0 })
                }
                min={0}
                max={96}
              />
              <QFColorControl
                label="Excerpt color"
                value={attributes.singleExcerptColor || ''}
                onChange={(val) =>
                  setAttributes({ singleExcerptColor: val })
                }
              />
              <SelectControl
                label="Excerpt alignment"
                value={attributes.singleExcerptAlignment || 'left'}
                options={[
                  { label: 'Left', value: 'left' },
                  { label: 'Center', value: 'center' },
                  { label: 'Right', value: 'right' },
                ...
                onChange={(val) =>
                  setAttributes({ singleExcerptAlignment: val })
                }
              />
              <TextControl
                label="Date format"
                help="PHP date format; leave empty for site default"
                value={attributes.singleDateFormat || ''}
                onChange={(val) =>
                  setAttributes({ singleDateFormat: val })
                }
              />
              <RangeControl
                label="Date font size (px)"
                value={attributes.singleDateFontSize || 0}
                onChange={(val) =>
                  setAttributes({ singleDateFontSize: val ?? 0 })
                }
                min={0}
                max={96}
              />
              <QFColorControl
                label="Date color"
                value={attributes.singleDateColor || ''}
                onChange={(val) => setAttributes({ singleDateColor: val })}
              />
              <RangeControl
                label="Author font size (px)"
                value={attributes.singleAuthorFontSize || 0}
                onChange={(val) =>
                  setAttributes({ singleAuthorFontSize: val ?? 0 })
                }
                min={0}
                max={96}
              />
              <QFColorControl
                label="Author color"
                value={attributes.singleAuthorColor || ''}
                onChange={(val) =>
                  setAttributes({ singleAuthorColor: val })
                }
              />
              <SelectControl
                label="Terms style"
                value={attributes.singleTermsStyle || 'pills'}
                options={[
                ...
                onChange={(val) =>
                  setAttributes({ singleTermsStyle: val })
                }
              />
              <RangeControl
                label="Terms font size (px)"
                value={attributes.singleTermsFontSize || 0}
                onChange={(val) =>
                  setAttributes({ singleTermsFontSize: val ?? 0 })
                }
                min={0}
                max={96}
              />
              <QFColorControl
                label="Terms color"
                value={attributes.singleTermsColor || ''}
                onChange={(val) =>
                  setAttributes({ singleTermsColor: val })
                }
              />
              <TextControl
                label="Nav previous label"
                value={attributes.singleNavPrevLabel || 'Previous'}
                onChange={(val) =>
                  setAttributes({ singleNavPrevLabel: val })
                }
              />
              <TextControl
                label="Nav next label"
                value={attributes.singleNavNextLabel || 'Next'}
                onChange={(val) =>
                  setAttributes({ singleNavNextLabel: val })
                }
              />
              <RangeControl
                label="Nav font size (px)"
                value={attributes.singleNavFontSize || 0}
                onChange={(val) =>
                  setAttributes({ singleNavFontSize: val ?? 0 })
                }
                min={0}
                max={96}
              />
              <QFColorControl
                label="Nav color"
                value={attributes.singleNavColor || ''}
                onChange={(val) => setAttributes({ singleNavColor: val })}
              />
            </>
          )}
        </PanelBody>
      ...
      {isModalOpen &&
        createPortal(
          <QueryBuilderModal
            ...
            backupContextLabel={backupContextLabel}
            onSave={(data) => {
              setAttributes({
